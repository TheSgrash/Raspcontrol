    ...
    <table>
        <tr id="check-system">
            ...
            <td class="infos">
                ...
                <br />distribuzione: <span class="text-info"><?php echo Rbpi::distribution(); ?></span>
        ...
        <tr id="check-env-heat">
            <td class="check"><i class="icon-fire"></i> Temp. Ambiente</td>
            <td class="icon"><?php echo icon_alert($env_heat['alert']); ?></td>
            <td class="infos">
                <div class="progress">
                    <div class="bar bar-<?php echo $env_heat['alert']; ?>" style="width: <?php echo $env_heat['percentage']; ?>%;"><?php echo $env_heat['degrees']; ?>° C</div>
                </div>
            </td>
        </tr>
        ...
        <tr id="check-ram">
            ...
            <td class="infos">
                ...
                <div id="popover-ram-head" class="hide">Top proc. in RAM</div>
                <div id="popover-ram-body" class="hide"><?php echo shell_to_html_table_result($ram['detail']); ?></div>
                free: <span class="text-success"><?php echo $ram['free']; ?>Mb</span>  &middot; usati: <span class="text-warning"><?php echo $ram['used']; ?>Mb</span> &middot; totali: <?php echo $ram['total']; ?>Mb
            </td>
        </tr>
		<?php if($swap['percentage']){?>
        <tr id="check-swap">
            ...
            <td class="infos">
                ...
                free: <span class="text-success"><?php echo $swap['free']; ?>Mb</span>  &middot; usati: <span class="text-warning"><?php echo $swap['used']; ?>Mb</span> &middot; totali: <?php echo $swap['total']; ?>Mb
            </td>
        </tr>
		<?php }?>
        <tr id="check-cpu">
            ...
            <td class="infos">
                ...
                <br />clock <span class="text-info"><?php echo $cpu['current']; ?></span> (min: <?php echo $cpu['min']; ?>  &middot;  max: <?php echo $cpu['max']; ?>)
        ...
        <tr id="check-cpu-heat">
            ...
            <td class="infos">
                ...
                <div id="popover-cpu-head" class="hide">Top proc. sulla CPU</div>
                <div id="popover-cpu-body" class="hide"><?php echo shell_to_html_table_result($cpu_heat['detail']); ?></div>
                temp.: <span class="text-info"><?php echo $cpu_heat['degrees']; ?>°C</span>
            </td>
        </tr>
        ...
        <tr class="storage" id="check-storage">
            ...
            <td class="infos">
              ...
              free: <span class="text-success">', $hdd[$i]['free'], 'b</span> &middot; usati: <span class="text-warning">', $hdd[$i]['used'], 'b</span> &middot; totali: ', $hdd[$i]['total'], 'b &middot; format: ', $hdd[$i]['format'], '
            </td>
          </tr>
        ...
        <tr id="check-network">
            ...
            <td class="infos">
                ...
                <br />ricevuti: <strong><?php echo $net_eth['down']; ?>Mb</strong> &middot; trasmessi: <strong><?php echo $net_eth['up']; ?>Mb</strong> &middot; totali: <?php echo $net_eth['total']; ?>Mb
                <br />connessioni: <?php echo $net_connections['connections']; ?>
            </td>
        </tr>
                ...
                <ul class="unstyled">
                    ...
                    if (sizeof($users) > 0) {
                        for ($i = 0; $i < sizeof($users); $i++)
                            echo '<li><span class="text-info">', $users[$i]['user'], '</span> dal ', $users[$i]['date'], ' alle ', $users[$i]['hour'], ' da <strong>', $users[$i]['ip'], '</strong> ', $users[$i]['dns'], '</li>', "\n";
                    }
                    else
                        echo '<li>nessun utente loggato</li>';
                    ?>
                </ul>
            </td>
        </tr>
