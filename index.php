            ...
            for ($i = 0; $i < sizeof($services); $i++) {
                if ($services[$i]['name'] == $_GET['servicename']) {
                    if ($services[$i]['status'] == '+') {
                        $ssh->exec("sudo systemctl stop " . $services[$i]['name']);
                        echo "Service: " . $services[$i]['name'] . " stopped";
                    } else {
                        $ssh->exec("sudo systemctl start " . $services[$i]['name']);
            ...
            <div class="container">
				<div class="nav-collapse collapse">
					<div class="nav pull-right">
						&nbsp;&nbsp;<br>
						<a href="<?php echo LOGOUT; ?>"><i class="icon-off icon-white"></i> Logout</a>&nbsp;&nbsp;&nbsp;
						<a data-rootaction="reboot" class="rootaction" href="#"><i class="icon-repeat icon-white"></i> Reboot</a>&nbsp;&nbsp;&nbsp;
						<a data-rootaction="shutdown" class="rootaction" href="#"><i class="icon-stop icon-white"></i> Shutdown</a>
					</div>
				</div>
				<a href="<?php echo INDEX; ?>"><img src="img/raspcontrol.png" alt="rbpi" /></a>
                <h1><a href="<?php echo INDEX; ?>">TheRaspcontrol</a></h1>
                <h2>TheSgrash Raspberry Pi Control Center</h2>
			</div>
        </header>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            ...
                            <li<?php is_active('details'); ?>><a href="<?php echo DETAILS; ?>"><i class="icon-search icon-white"></i> Dettagli</a></li>
                            <li<?php is_active('services'); ?>><a href="<?php echo SERVICES; ?>"><i class="icon-cog icon-white"></i> Servizi</a></li>
                            <li<?php is_active('disks'); ?>><a href="<?php echo DISKS; ?>"><i class="icon-disks icon-white"></i> Dischi</a></li>
                            <li<?php is_active('xiaomicam'); ?>><a href="<?php echo CAM; ?>"><i class="icon-download icon-white"></i> Remote Cam</a></li>
                            <li<?php is_active('torrents'); ?>><a href="<?php echo TORRENTS; ?>"><i class="icon-download icon-white"></i> Torrent</a></li>
                            <li<?php is_active('hometemp'); ?>><a href="<?php echo HOMETEMP; ?>"><i class="icon-fire icon-white"></i> Home Temp.</a></li>
                            <li<?php is_active('downloads'); ?>><a href="<?php echo DOWNLOADS; ?>"><i class="icon-download-alt icon-white"></i> Downloads</a></li>
                        </ul>
					</div>
                </div>
            </div>
